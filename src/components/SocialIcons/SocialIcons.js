...
const SocialIcons = (props, context) => {
  ...
  // https://discuss.dev.twitch.tv/u/AlbericoD/
  return (
    <div className="social-icons animate-icons">
      ...
      <a
        target="_blank"
        rel="noopener noreferrer"
        href="https://stackoverflow.com/users/8221557/alb%C3%A9rico-dias-barreto-filho"
        style={{ color: colorPrimary }}
      >
      ...
      <a
        target="_blank"
        rel="noopener noreferrer"
        href="https://medium.com/@albricodiasbarretofilho"
        style={{ color: colorPrimary }}
      >
      ...
      <a
        target="_blank"
        rel="noopener noreferrer"
        href="https://discuss.dev.twitch.tv/u/AlbericoD/"
        style={{ color: colorPrimary }}
      >
