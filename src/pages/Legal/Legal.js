  ...
  render() {
    return (
      <div className="legal-page">
        ...
        <br />
        <p>
          By accessing the our twitch extension, and other services we own and
          operate, you are agreeing to be bound by these terms of service, all
          ...
          our twitch extension, and other services we own and operate. The
          materials contained in our twitch extension, and other services we own
          and operate are protected by applicable copyright and trademark law.
        </p>
        <br />
        <h3>2. Use License</h3>
        <br />
        <ol type="a">
          <li>
            Permission is granted to temporarily use one copy of the materials
            (information or software) on Albérico Dias Barreto Filho's our
            twitch extension, and other services we own and operate . This is
        ...
        <ol type="a">
          <li>
            The materials on Albérico Dias Barreto Filho's our twitch extension,
            and other services we own and operate are provided on an 'as is'
            basis. Albérico Dias Barreto Filho makes no warranties, expressed or
          ...
          <li>
            ...
            relating to such materials or on any sites linked to our twitch
            extension, and other services we own and operate.
          </li>
        </ol>
        <br />
        <h3>4. Limitations</h3>
        ...
        <p>
          ...
          of the use or inability to use the materials on our twitch extension,
          and other services we own and operate, even if Albérico Dias Barreto
          Filho or a Albérico Dias Barreto Filho authorized representative has
        ...
        <br />
        <p>
          The materials appearing on Albérico Dias Barreto Filho's our twitch
          extension, and other services we own and operate could include
          technical, typographical, or photographic errors. Albérico Dias
          Barreto Filho does not warrant that any of the materials on its our
          twitch extension, and other services we own and operate are accurate,
          complete or current. Albérico Dias Barreto Filho may make changes to
          the materials contained on its our twitch extension, and other
          services we own and operate at any time without notice. However
          Albérico Dias Barreto Filho does not make any commitment to update the
          materials.
        </p>
        <br />
        <h3>6. Links</h3>
    ...
    return (
      <div className="legal-page">
        ...
        <p>
          ...
          collect from you across our twitch extension, and other services we
          own and operate.
        </p>
        <br />
        <p>
        ...
        <br />
        <p>
          Your continued use of our our twitch extension, and other services we
          own and operate will be regarded as acceptance of our practices around
